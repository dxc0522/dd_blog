...
{%  image /assets/img/found/32.png %}

下面是几个详细的流程：

简单的说：弄清楚你的自身情况，和你用来投资的这部分钱，大概投资多久。

{%  image /assets/img/found/33.png %}
{%  image /assets/img/found/34.png %}
{%  image /assets/img/found/35.png %}
...
{%  image /assets/img/found/7.jpg %}


比如专门投资于医疗行业的

{%  image /assets/img/found/8.jpg %}


比如专门投资于沪港深主题的

{%  image /assets/img/found/9.jpg %}
...
{%  image /assets/img/found/26.jpg %}


然后我们随便拉下目前市场上的货币基金，

{%  image /assets/img/found/27.jpg %}
